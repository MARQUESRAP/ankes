...
function HistoryPage() {
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // Filtres
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('quotes');
    ...
    const loadData = async ()=>{
        try {
            const [docs, clientsData] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$documents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["documentsService"].getAll(),
    ...
    const acceptedDocuments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HistoryPage.useMemo[acceptedDocuments]": ()=>{
            return documents.filter({
                "HistoryPage.useMemo[acceptedDocuments]": (doc)=>{
                    if (doc.type === 'quote') {
    ...
    const filteredDocuments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HistoryPage.useMemo[filteredDocuments]": ()=>{
            let filtered = acceptedDocuments.filter({
                "HistoryPage.useMemo[filteredDocuments].filtered": (doc)=>activeTab === 'quotes' ? doc.type === 'quote' : doc.type === 'invoice'
            }["HistoryPage.useMemo[filteredDocuments].filtered"]);
            // Filtre par recherche
            if (searchQuery) {
                const query = searchQuery.toLowerCase();
                filtered = filtered.filter({
                    "HistoryPage.useMemo[filteredDocuments]": (doc)=>doc.number.toLowerCase().includes(query) || doc.client?.name.toLowerCase().includes(query)
                }["HistoryPage.useMemo[filteredDocuments]"]);
            }
            // Filtre par client
            if (selectedClient) {
                filtered = filtered.filter({
                    "HistoryPage.useMemo[filteredDocuments]": (doc)=>doc.client_id === selectedClient
                }["HistoryPage.useMemo[filteredDocuments]"]);
            }
            // Filtre par statut
            if (selectedStatus) {
                filtered = filtered.filter({
                    "HistoryPage.useMemo[filteredDocuments]": (doc)=>doc.status === selectedStatus
                }["HistoryPage.useMemo[filteredDocuments]"]);
            }
            // Filtre par date
            if (dateFrom) {
                filtered = filtered.filter({
                    "HistoryPage.useMemo[filteredDocuments]": (doc)=>doc.issue_date >= dateFrom
                }["HistoryPage.useMemo[filteredDocuments]"]);
            }
            if (dateTo) {
                filtered = filtered.filter({
                    "HistoryPage.useMemo[filteredDocuments]": (doc)=>doc.issue_date <= dateTo
                }["HistoryPage.useMemo[filteredDocuments]"]);
            }
            // Trier par date décroissante
            return filtered.sort({
                "HistoryPage.useMemo[filteredDocuments]": (a, b)=>new Date(b.issue_date).getTime() - new Date(a.issue_date).getTime()
            }["HistoryPage.useMemo[filteredDocuments]"]);
        }
    }["HistoryPage.useMemo[filteredDocuments]"], [
        acceptedDocuments,
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HistoryPage.useMemo[stats]": ()=>{
            const totalAmount = filteredDocuments.reduce({
                "HistoryPage.useMemo[stats].totalAmount": (sum, doc)=>sum + (doc.total_ttc || 0)
            }["HistoryPage.useMemo[stats].totalAmount"], 0);
            const uniqueClients = new Set(filteredDocuments.map({
                "HistoryPage.useMemo[stats]": (doc)=>doc.client_id
            }["HistoryPage.useMemo[stats]"])).size;
    ...
    const handleExportCSV = ()=>{
        ...
        const rows = filteredDocuments.map((doc)=>[
                doc.number,
                doc.client?.name || '',
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(doc.issue_date),
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-xl font-bold text-gray-800 dark:text-white",
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(stats.avgAmount)
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/history/page.tsx",
                                                lineNumber: 309,
                                                columnNumber: 17
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: filteredDocuments.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        lineNumber: 381,
                                        columnNumber: 21
                                    }, this) : filteredDocuments.map((doc)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-6 py-4 text-gray-600 dark:text-gray-300",
                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(doc.issue_date)
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/history/page.tsx",
                                                    lineNumber: 393,
                                                    columnNumber: 25
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(doc.total_ttc || 0)
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/history/page.tsx",
                                                    lineNumber: 394,
                                                    columnNumber: 25
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    docsForDay.slice(0, 2).map((doc)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            onClick: ()=>router.push(`/${doc.type === 'quote' ? 'quotes' : 'invoices'}/${doc.id}`),
                                                    ...
                                                    docsForDay.length > 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HistoryPage, "DfRS/X10GwobA4WCqehGfB5oOaw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_17cad3e3._.js.map
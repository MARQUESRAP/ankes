...
"[project]/src/app/invoices/[id]/edit/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditInvoicePage() {
    ...
    const loadData = async ()=>{
        try {
            const [clientsData, userData, invoiceData] = await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$documents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["documentsService"].getById(invoiceId)
            ]);
            ...
            if (invoiceData) {
                ...
                setIssueDate((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDateForInput"])(new Date(invoiceData.issue_date)));
                setDueDate(invoiceData.due_date ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDateForInput"])(new Date(invoiceData.due_date)) : '');
    ...
    const handleSave = async (newStatus)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$documents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["documentsService"].update(invoiceId, {
                client_id: clientId,
                issue_date: issueDate,
                due_date: dueDate,
                notes,
            ...
            if (newStatus) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$documents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["documentsService"].updateStatus(invoiceId, newStatus);
            }
            ...
            if (newStatus === 'sent' && selectedClient) {
                ...
                const pdfUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storageService"].uploadPDF(blob, `${invoice?.number}.pdf`);
...
_s(EditInvoicePage, "p646tqchPXiW9i1KLhHcuPH6vQE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=src_019021d4._.js.map
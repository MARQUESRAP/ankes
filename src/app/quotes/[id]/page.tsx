...
export default function EditQuotePage() {
  ...
  const handleSaveAndSend = async () => {
    ...
    try {
      ...
      await documentsService.updateStatus(quoteId, 'sent');
      ...
      if (selectedClient) {
        ...
        await storageService.uploadPDF(blob, `${quote?.number}.pdf`);
      }
    ...
    return (
      <AppLayout>
        <div className="text-center py-12">
          ...
          <Button variant="secondary" onClick={() => router.push('/quotes')} className="mt-4">
            Retour aux devis
          </Button>
        </div>
      </AppLayout>
